...
class Ui_TelaMain(object):
    def setupUi(self, MainWindow):
        ...
        item = QtWidgets.QTableWidgetItem()
        self.tw_estoque.setHorizontalHeaderItem(3, item)
        ...
        self.tw_saida = QtWidgets.QTableWidget(self.tables)
        self.tw_saida.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOn)
        self.tw_saida.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOn)
        self.tw_saida.setObjectName("tw_saida")
        self.tw_saida.setColumnCount(6)
        self.tw_saida.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.tw_saida.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.tw_saida.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.tw_saida.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.tw_saida.setHorizontalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        self.tw_saida.setHorizontalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        self.tw_saida.setHorizontalHeaderItem(5, item)
        ...
        self.btn_cadastrar.setGeometry(QtCore.QRect(330, 380, 161, 41))
        font = QtGui.QFont()
        font.setPointSize(-1)
        font.setUnderline(False)
        font.setStrikeOut(False)
        ...
        self.msg_box = QtWidgets.QLabel(self.frame_3)
        self.msg_box.setGeometry(QtCore.QRect(180, 320, 481, 41))
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        font.setPointSize(14)
        ...
        self.lineEdit_4.setGeometry(QtCore.QRect(400, 60, 201, 41))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.label_8.setGeometry(QtCore.QRect(230, 60, 161, 41))
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        font.setPointSize(14)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_home.setText(_translate("MainWindow", "Página Inicial"))
        self.btn_produtos.setText(_translate("MainWindow", "Painel"))
        self.btn_venda.setText(_translate("MainWindow", "Vendas"))
        self.btn_logout.setText(_translate("MainWindow", "Sair"))
        self.btn_open.setText(_translate("MainWindow", "Procurar"))
        self.label_3.setText(_translate("MainWindow", "Estoque"))
        item = self.tw_estoque.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Cod. Poduto"))
        ...
        item = self.tw_estoque.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "Preço R$"))
        self.label_2.setText(_translate("MainWindow", "Saida"))
        item = self.tw_saida.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "ID Venda"))
        item = self.tw_saida.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Produto"))
        item = self.tw_saida.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "Valor"))
        item = self.tw_saida.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "Quantidade"))
        item = self.tw_saida.horizontalHeaderItem(4)
        item.setText(_translate("MainWindow", "Vendedor"))
        item = self.tw_saida.horizontalHeaderItem(5)
        ...
        self.tabWidget.setTabText(
            self.tabWidget.indexOf(self.tables), _translate("MainWindow", "Painel")
        )
